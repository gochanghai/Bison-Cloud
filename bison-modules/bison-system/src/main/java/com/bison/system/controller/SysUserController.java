...
import com.bison.common.core.utils.bean.BeanUtils;
...
public class SysUserController extends BaseController {
    ...
    public R<UserInfo> info(@PathVariable("username") String username) {
        ...
        com.bison.system.api.domain.SysUser user = new com.bison.system.api.domain.SysUser();
    ...
    public CommonResult getInfo(@PathVariable(value = "userId", required = false) Long userId) {
        ...
        if (StringUtils.isNotNull(userId)) {
            ajax.put(CommonResult.DATA_TAG, userService.selectUserById(userId));
